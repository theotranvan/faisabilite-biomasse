...
const meteoMoyenneData = [
  { departement: 'Ain', code: '01', djuMoyenne: 2450, tempExtBase: -10 },
  { departement: 'Aisne', code: '02', djuMoyenne: 2290, tempExtBase: -9 },
  { departement: 'Allier', code: '03', djuMoyenne: 2350, tempExtBase: -8 },
  { departement: 'Alpes-de-Haute-Provence', code: '04', djuMoyenne: 2100, tempExtBase: -8 },
  { departement: 'Hautes-Alpes', code: '05', djuMoyenne: 2180, tempExtBase: -10 },
  { departement: 'Alpes-Maritimes', code: '06', djuMoyenne: 1700, tempExtBase: -2 },
  { departement: 'Ardèche', code: '07', djuMoyenne: 2100, tempExtBase: -6 },
  { departement: 'Ardennes', code: '08', djuMoyenne: 2450, tempExtBase: -10 },
  { departement: 'Ariège', code: '09', djuMoyenne: 2200, tempExtBase: -5 },
  { departement: 'Aube', code: '10', djuMoyenne: 2350, tempExtBase: -10 },
  { departement: 'Aude', code: '11', djuMoyenne: 1950, tempExtBase: -4 },
  { departement: 'Aveyron', code: '12', djuMoyenne: 2300, tempExtBase: -8 },
  { departement: 'Bouches-du-Rhône', code: '13', djuMoyenne: 1850, tempExtBase: -4 },
  { departement: 'Calvados', code: '14', djuMoyenne: 2100, tempExtBase: -7 },
  { departement: 'Cantal', code: '15', djuMoyenne: 2500, tempExtBase: -10 },
  { departement: 'Charente', code: '16', djuMoyenne: 2000, tempExtBase: -5 },
  { departement: 'Charente-Maritime', code: '17', djuMoyenne: 1950, tempExtBase: -4 },
  { departement: 'Cher', code: '18', djuMoyenne: 2250, tempExtBase: -7 },
  { departement: 'Corrèze', code: '19', djuMoyenne: 2350, tempExtBase: -8 },
  { departement: 'Corse-du-Sud', code: '2A', djuMoyenne: 1650, tempExtBase: -2 },
  { departement: 'Haute-Corse', code: '2B', djuMoyenne: 1700, tempExtBase: -2 },
  { departement: 'Côte-d\'Or', code: '21', djuMoyenne: 2400, tempExtBase: -10 },
  { departement: 'Côtes-d\'Armor', code: '22', djuMoyenne: 2200, tempExtBase: -4 },
  { departement: 'Creuse', code: '23', djuMoyenne: 2450, tempExtBase: -8 },
  { departement: 'Dordogne', code: '24', djuMoyenne: 2050, tempExtBase: -5 },
  { departement: 'Doubs', code: '25', djuMoyenne: 2550, tempExtBase: -12 },
  { departement: 'Drôme', code: '26', djuMoyenne: 2050, tempExtBase: -6 },
  { departement: 'Eure', code: '27', djuMoyenne: 2300, tempExtBase: -7 },
  { departement: 'Eure-et-Loir', code: '28', djuMoyenne: 2350, tempExtBase: -7 },
  { departement: 'Finistère', code: '29', djuMoyenne: 2200, tempExtBase: -4 },
  { departement: 'Gard', code: '30', djuMoyenne: 1900, tempExtBase: -4 },
  { departement: 'Haute-Garonne', code: '31', djuMoyenne: 2100, tempExtBase: -5 },
  { departement: 'Gers', code: '32', djuMoyenne: 1950, tempExtBase: -5 },
  { departement: 'Gironde', code: '33', djuMoyenne: 1950, tempExtBase: -4 },
  { departement: 'Hérault', code: '34', djuMoyenne: 1850, tempExtBase: -3 },
  { departement: 'Ille-et-Vilaine', code: '35', djuMoyenne: 2150, tempExtBase: -5 },
  { departement: 'Indre', code: '36', djuMoyenne: 2300, tempExtBase: -7 },
  { departement: 'Indre-et-Loire', code: '37', djuMoyenne: 2200, tempExtBase: -6 },
  { departement: 'Isère', code: '38', djuMoyenne: 2350, tempExtBase: -10 },
  { departement: 'Jura', code: '39', djuMoyenne: 2600, tempExtBase: -12 },
  { departement: 'Landes', code: '40', djuMoyenne: 1850, tempExtBase: -4 },
  { departement: 'Loir-et-Cher', code: '41', djuMoyenne: 2300, tempExtBase: -7 },
  { departement: 'Loire', code: '42', djuMoyenne: 2350, tempExtBase: -8 },
  { departement: 'Haute-Loire', code: '43', djuMoyenne: 2450, tempExtBase: -10 },
  { departement: 'Loire-Atlantique', code: '44', djuMoyenne: 2050, tempExtBase: -5 },
  { departement: 'Loiret', code: '45', djuMoyenne: 2350, tempExtBase: -7 },
  { departement: 'Lot', code: '46', djuMoyenne: 2050, tempExtBase: -6 },
  { departement: 'Lot-et-Garonne', code: '47', djuMoyenne: 1950, tempExtBase: -5 },
  { departement: 'Lozère', code: '48', djuMoyenne: 2550, tempExtBase: -10 },
  { departement: 'Maine-et-Loire', code: '49', djuMoyenne: 2100, tempExtBase: -5 },
  { departement: 'Manche', code: '50', djuMoyenne: 2100, tempExtBase: -5 },
  { departement: 'Marne', code: '51', djuMoyenne: 2400, tempExtBase: -10 },
  { departement: 'Haute-Marne', code: '52', djuMoyenne: 2550, tempExtBase: -12 },
  { departement: 'Mayenne', code: '53', djuMoyenne: 2150, tempExtBase: -5 },
  { departement: 'Meurthe-et-Moselle', code: '54', djuMoyenne: 2450, tempExtBase: -12 },
  { departement: 'Meuse', code: '55', djuMoyenne: 2500, tempExtBase: -12 },
  { departement: 'Morbihan', code: '56', djuMoyenne: 2100, tempExtBase: -4 },
  { departement: 'Moselle', code: '57', djuMoyenne: 2450, tempExtBase: -12 },
  { departement: 'Nièvre', code: '58', djuMoyenne: 2400, tempExtBase: -8 },
  { departement: 'Nord', code: '59', djuMoyenne: 2550, tempExtBase: -9 },
  { departement: 'Oise', code: '60', djuMoyenne: 2350, tempExtBase: -8 },
  { departement: 'Orne', code: '61', djuMoyenne: 2200, tempExtBase: -7 },
  { departement: 'Pas-de-Calais', code: '62', djuMoyenne: 2450, tempExtBase: -9 },
  { departement: 'Puy-de-Dôme', code: '63', djuMoyenne: 2450, tempExtBase: -8 },
  { departement: 'Pyrénées-Atlantiques', code: '64', djuMoyenne: 1900, tempExtBase: -5 },
  { departement: 'Hautes-Pyrénées', code: '65', djuMoyenne: 2200, tempExtBase: -5 },
  { departement: 'Pyrénées-Orientales', code: '66', djuMoyenne: 1750, tempExtBase: -3 },
  { departement: 'Bas-Rhin', code: '67', djuMoyenne: 2400, tempExtBase: -12 },
  { departement: 'Haut-Rhin', code: '68', djuMoyenne: 2350, tempExtBase: -12 },
  { departement: 'Rhône', code: '69', djuMoyenne: 2250, tempExtBase: -8 },
  { departement: 'Haute-Saône', code: '70', djuMoyenne: 2550, tempExtBase: -12 },
  { departement: 'Saône-et-Loire', code: '71', djuMoyenne: 2350, tempExtBase: -10 },
  { departement: 'Sarthe', code: '72', djuMoyenne: 2200, tempExtBase: -6 },
  { departement: 'Savoie', code: '73', djuMoyenne: 2550, tempExtBase: -10 },
  { departement: 'Haute-Savoie', code: '74', djuMoyenne: 2600, tempExtBase: -10 },
  { departement: 'Paris', code: '75', djuMoyenne: 2350, tempExtBase: -5 },
  { departement: 'Seine-Maritime', code: '76', djuMoyenne: 2300, tempExtBase: -7 },
  { departement: 'Seine-et-Marne', code: '77', djuMoyenne: 2350, tempExtBase: -7 },
  { departement: 'Yvelines', code: '78', djuMoyenne: 2350, tempExtBase: -7 },
  { departement: 'Deux-Sèvres', code: '79', djuMoyenne: 2050, tempExtBase: -5 },
  { departement: 'Somme', code: '80', djuMoyenne: 2450, tempExtBase: -9 },
  { departement: 'Tarn', code: '81', djuMoyenne: 2050, tempExtBase: -5 },
  { departement: 'Tarn-et-Garonne', code: '82', djuMoyenne: 1950, tempExtBase: -5 },
  { departement: 'Var', code: '83', djuMoyenne: 1800, tempExtBase: -3 },
  { departement: 'Vaucluse', code: '84', djuMoyenne: 1950, tempExtBase: -4 },
  { departement: 'Vendée', code: '85', djuMoyenne: 2050, tempExtBase: -4 },
  { departement: 'Vienne', code: '86', djuMoyenne: 2000, tempExtBase: -5 },
  { departement: 'Haute-Vienne', code: '87', djuMoyenne: 2200, tempExtBase: -7 },
  { departement: 'Vosges', code: '88', djuMoyenne: 2550, tempExtBase: -12 },
  { departement: 'Yonne', code: '89', djuMoyenne: 2400, tempExtBase: -10 },
  { departement: 'Territoire de Belfort', code: '90', djuMoyenne: 2550, tempExtBase: -12 },
  { departement: 'Essonne', code: '91', djuMoyenne: 2350, tempExtBase: -7 },
  { departement: 'Hauts-de-Seine', code: '92', djuMoyenne: 2350, tempExtBase: -5 },
  { departement: 'Seine-Saint-Denis', code: '93', djuMoyenne: 2350, tempExtBase: -5 },
  { departement: 'Val-de-Marne', code: '94', djuMoyenne: 2350, tempExtBase: -5 },
  { departement: 'Val-d\'Oise', code: '95', djuMoyenne: 2350, tempExtBase: -7 },
];
